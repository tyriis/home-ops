...
**Check etcd Database Fragmentation**
...
### High Fragmentation Returns Quickly
...
- External resources
  - [talos etcd Maintenance](https://docs.siderolabs.com/talos/v1.11/build-and-extend-talos/cluster-operations-and-maintenance/etcd-maintenance)
- Support contacts
